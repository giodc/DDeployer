...
<head>
    ...
    <title>Login - {{ config('app.name', 'DDeployer') }}</title>
        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">
                    Sign in to DDeployer
                </h2>
                <p class="mt-2 text-center text-sm text-gray-600">
                    Docker Web Hosting Platform
                </p>
            </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                ...
                                <div class="mt-2 text-sm text-blue-700">
                                    <p>Email: <code class="bg-blue-100 px-1 rounded">admin@ddeployer.local</code></p>
